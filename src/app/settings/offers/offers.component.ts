...
@Component({
  ...
  styleUrls: ['../shared/kp-content-page.css']
})
    ...
    this.offers = [
      {
        ...
        benefits: ['Quick payouts', 'Trusted service', 'Smooth gaming experience'],
        terms: 'T&C Apply',
        cardType: 'primary'
      },
      {
        ...
        benefits: ['Play with confidence', 'Faster banking support', 'Premium player benefits'],
        terms: 'T&C Apply',
        cardType: 'secondary'
      },
      {
        ...
        benefits: ['Secure', 'Reliable', 'Player first'],
        terms: 'T&C Apply',
        cardType: 'tertiary'
      },
      {
        ...
        description: 'If your bank account gets frozen due to withdrawal transactions from our platform, we will provide another withdrawal opportunity after verification.',
        benefits: [
          'Submit all required details and proof requested by support',
          'Safe support',
          'Quick assistance',
          'Trusted service'
        ],
